        ...
        public function render () {
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
                    ...
                    if ( $this->field[ 'show' ][ 'custom' ] ) {
                        $placeholder = ( isset ( $this->field[ 'placeholder' ][ 'custom' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'custom' ] ) : __ ( 'Custom HTML', 'redux-framework' );
                        echo '<li><textarea name="' . $this->field[ 'name' ] . '[' . $x . '][custom]' . $this->field['name_suffix'] . '" id="' . $this->field[ 'id' ] . '-custom' . $x . '" placeholder="' . $placeholder . '" class="large-text" rows="6">' . esc_attr ( $slide[ 'custom' ] ) . '</textarea></li>';
                    }
                    ...
                    if ( $this->field[ 'show' ][ 'additional_background' ] ) {
                        $placeholder = ( isset ( $this->field[ 'placeholder' ][ 'additional_background' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'additional_background' ] ) : __ ( 'Enter color or image url', 'redux-framework' );
                        echo '<li><input type="text" name="' . $this->field[ 'name' ] . '[' . $x . '][additional_background]' . $this->field['name_suffix'] . '" id="' . $this->field[ 'id' ] . '-additional_background' . $x . '" placeholder="' . $placeholder . '" class="large-text" value="' . esc_attr ( $slide[ 'additional_background' ] ) . '"></li>';
                    }
