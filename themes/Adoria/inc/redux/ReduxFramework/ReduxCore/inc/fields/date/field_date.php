...
if ( ! class_exists( 'ReduxFramework_date' ) ) {
    ...
    class ReduxFramework_date {
        ...
        public function render() {
            ...
            echo '<input data-id="' . $this->field['id'] . '" type="date" id="' . $this->field['id'] . '-date" name="' . $this->field['name'] . $this->field['name_suffix'] . '"' . $placeholder . 'value="' . $this->value . '" class="redux-datepicker ' . $this->field['class'] . '" />';
        }
